<x-app-layout>
    ...
    <h1 class="mt-8 text-2xl font-medium" style="text-align:center">
        HOMEPAGE
    </h1>

    <p class="mt-6 text-gray-300 leading-relaxed" style="text-align:center">
    ...
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ms-3 text-xl font-semibold text-gray-900">
                <a href="{{ route("dashboard") }}">Go To The Dashboard Here</a>
            </h2>
        </div>
